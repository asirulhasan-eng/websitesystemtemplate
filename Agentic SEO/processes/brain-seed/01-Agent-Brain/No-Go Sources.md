...
blocked_terms:
  - term: switch.monster
    ...
    applies_to_fields:
      ...
      - description
      - metadata
    reason: Fake-impression data confirmed by Site Owner. Never create, recommend, prioritize, or execute work derived from it.
...
> or execute tasks derived from it unless Site Owner explicitly overrides.
