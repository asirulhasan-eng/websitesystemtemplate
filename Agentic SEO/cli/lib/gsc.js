...
async function getGscAccessToken(config) {
  ...
  const clientId = config.get("GSC_CLIENT_ID") || config.get("GSC_WEBSITE_AGENT_ID");
  const clientSecret = config.get("GSC_CLIENT_SECRET") || config.get("GSC_WEBSITE_AGENT_SECRET");
